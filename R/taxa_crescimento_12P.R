taxa_crescimento_12P <- function(x){
  glm <- list()
  for(i in names(taxa_cresc)[-1]){
    glm[[i]] <- lm(get(i) ~ ano, taxa_cresc)
  }
  ...
  pais <- c("País 1 (Período 1)", "País 1 (Período 2)",	"País 1 (Período 3)",	"País 1 (Período 4)", "País 2 (Período 1)", "País 2 (Período 2)",	"País 2 (Período 3)",	"País 2 (Período 4)", "País 3 (Período 1)", "País 3 (Período 2)",	"País 3 (Período 3)",	"País 3 (Período 4)")
